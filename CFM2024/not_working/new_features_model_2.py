...
# New features to see if performance changes

input_file = 'X_test_m4HAPAP.csv'
output_file = 'X_test_processed_3.csv'
chunk_size = 100000
...
"max_spread"
    ...
    X = new.drop(columns=drop_col)
    
    # Force the index name to be 'obs_id' to prevent the lambda function bug
    X.index.name = 'obs_id'
    X = X.reset_index()
