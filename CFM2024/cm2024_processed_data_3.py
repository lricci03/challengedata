...
# Training the model on X_train_processed_3.csv (some time-dependent features removed)
# and with a train:validation split of 2:1
# The accuracy drops to 0.3, which is similar to what we get on the test set
# The most important features are mean_queue_depth and mean_flux_abs
# If we remove them, the accuracy drops to 0.17
...
# dropping the most important features 
